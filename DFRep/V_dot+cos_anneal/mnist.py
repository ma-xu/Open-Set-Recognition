...
parser.add_argument('--alpha', default=0.0, type=float, help='scaling cosine distance for exp')
...
args.checkpoint = './checkpoints/mnist/%s-%s_%s_dim%s_alpha%s' % (
    args.train_class_num, args.test_class_num, args.arch, args.embed_dim,args.alpha)
...
def main_stage1():
    ...
    if args.stage1_resume:
        ...
        logger.set_names(['Epoch', 'Train Loss',"Cls Loss", 'Cosine Loss', 'Train Acc.'])
