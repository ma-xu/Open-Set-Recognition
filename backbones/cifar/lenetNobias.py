...
class LeNetNobias(nn.Module):
    def __init__(self, num_classes=10, backbone_fc=True):
        ...
        self.conv1_1 = nn.Conv2d(1, 32, 5, stride=1, padding=2, bias=False)
        self.prelu1_1 = nn.PReLU()
        self.conv1_2 = nn.Conv2d(32, 32, 5, stride=1, padding=2, bias=False)
        self.prelu1_2 = nn.PReLU()

        self.conv2_1 = nn.Conv2d(32, 64, 5, stride=1, padding=2, bias=False)
        self.prelu2_1 = nn.PReLU()
        self.conv2_2 = nn.Conv2d(64, 64, 5, stride=1, padding=2, bias=False)
        self.prelu2_2 = nn.PReLU()

        self.conv3_1 = nn.Conv2d(64, 128, 5, stride=1, padding=2, bias=False)
        self.prelu3_1 = nn.PReLU()
        self.conv3_2 = nn.Conv2d(128, 128, 5, stride=1, padding=2, bias=False)
        self.prelu3_2 = nn.PReLU()

        if backbone_fc:
            self.linear = nn.Sequential(
                nn.Linear(128 * 3 * 3, 2, bias=False),
                nn.PReLU(),
...
def demo():
    net = LeNetNobias(num_classes=10, backbone_fc=False)
