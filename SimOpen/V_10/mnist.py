...
from MyPlotter import plot_feature, plot_stackbar, stackbar_hist, singlebar_hist
...
def stage1_valtrain(net, trainloader, device):
    ...
    print(f"Training set pnorm static: min {pnorm_list.min()} | mid {pnorm_list.median()} | {pnorm_list.max()}")
