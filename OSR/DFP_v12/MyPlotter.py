...
def plot_gap(net,
    ...
    results["channel_mean_all"] = torch.cat(channel_mean_list, dim=0)
    results["channel_std_all"] = torch.cat(channel_std_list, dim=0)
