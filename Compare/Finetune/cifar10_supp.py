...
parser.add_argument('--stage1_resume',
                    default='./checkpoints/cifar10/7_10_ResNet18_dim128_gamma1/stage_1_last_model.pth',
...
parser.add_argument('--mode', default='A',choices=['A','B',"C","D"],type=str, help='mode for t_k and t_u')
...
def main_stage1():
    ...
    if args.mode == "A":
        ...
        t_u = mid_dict["mid_unknown"]
    elif args.mode == "B":
        t_k = mid_dict["mid_known"] *1.1
        t_u = mid_dict["mid_unknown"] *0.9
    elif args.mode == "C":
