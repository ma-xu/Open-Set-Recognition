...
def main():
    ...
    #!!Psoftmax equals we feed the ["normweight_fea2cen"] as inputs !#
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank == 0:
            ...
            logger.append([optimizer.param_groups[0]['lr'], train_loss, 0.0, train_acc, 0.0, 0.0])
            ...
            }, is_best,checkpoint=args.checkpoint,filename="checkpoint.pth.tar")
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, data in enumerate(train_loader):
        ...
        logits = output["normweight_fea2cen"]
