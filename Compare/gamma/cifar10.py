...
parser.add_argument('--stage1_resume',
                    default='/work/xm0036/Open-Set-Recognition/Compare/Metric_Methods/'
                            'checkpoints/cifar10/PSoftmaxLoss_energy_7_10_ResNet18_dim128-c0.03-s16-m0.5/'
                            'last_model.pth', type=str, metavar='PATH', help='path to latest checkpoint')
...
def main_stage1():
    ...
    if args.stage1_resume:
        ...
        print("Pretrained model is required.")
...
def main_stage2(net, mid_known, mid_unknown):
    ...
    if not args.evaluate:
        ...
        best_F1_list = torch.cat(best_F1_list,dim=0)
        last_five = best_F1_list[-5:]
